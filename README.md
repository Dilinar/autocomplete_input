...
Link to project: https://dilinar.github.io/autocomplete_input/

Just a simple autocomplete input. I wrote it to practice data fetching with axios. But I'm pleased with the result, so I've decided to add it to my portfolio.
